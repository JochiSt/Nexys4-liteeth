...
set_property PACKAGE_PIN G14 [get_ports {JB_acc_sclk}]
set_property IOSTANDARD LVCMOS33 [get_ports {JB_acc_sclk}]
# Bank = 14, Pin name = IO_L13P_T2_MRCC_14,					Sch name = JB2
set_property PACKAGE_PIN P15 [get_ports {JB_acc_miso}]
set_property IOSTANDARD LVCMOS33 [get_ports {JB_acc_miso}]
...
set_property PACKAGE_PIN V15 [get_ports {JB_acc_drdy}]
set_property IOSTANDARD LVCMOS33 [get_ports {JB_acc_drdy}]
# Bank = 15, Pin name = IO_25_15,							Sch name = JB7
set_property PACKAGE_PIN K16 [get_ports {JB_acc_mosi}]
set_property IOSTANDARD LVCMOS33 [get_ports {JB_acc_mosi}]
# Bank = CONFIG, Pin name = IO_L15P_T2_DQS_RWR_B_14,			Sch name = JB8
set_property PACKAGE_PIN R16 [get_ports {JB_acc_cs_n}]
set_property IOSTANDARD LVCMOS33 [get_ports {JB_acc_cs_n}]
# Bank = 14, Pin name = IO_L24P_T3_A01_D17_14,				Sch name = JB9
set_property PACKAGE_PIN T9 [get_ports {JB[9]}]
...
set_property PACKAGE_PIN K2 [get_ports {JC_dac_clk}]
set_property IOSTANDARD LVCMOS33 [get_ports {JC_dac_clk}]
# Bank = 35, Pin name = IO_L6P_T0_35,						Sch name = JC2
set_property PACKAGE_PIN E7 [get_ports {JC_dac_ld_n}]
set_property IOSTANDARD LVCMOS33 [get_ports {JC_dac_ld_n}]
...
set_property PACKAGE_PIN K1 [get_ports {JC_dac_cs_n}]
set_property IOSTANDARD LVCMOS33 [get_ports {JC_dac_cs_n}]
# Bank = 35, Pin name = IO_L5P_T0_AD13P_35,					Sch name = JC8
set_property PACKAGE_PIN E6 [get_ports {JC_dac_sdi}]
set_property IOSTANDARD LVCMOS33 [get_ports {JC_dac_sdi}]
...
################################################################################
# Accelerometer on the Nexys4 Board
################################################################################
